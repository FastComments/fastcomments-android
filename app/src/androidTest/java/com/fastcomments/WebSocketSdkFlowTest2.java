...
public class WebSocketSdkFlowTest2 extends UITestBase {

    private static final String TAG = "WsSdkFlow2";
    ...
    public void testSubscribeToChangesDirectly() throws Exception {
        String urlId = "ws-flow2-" + System.currentTimeMillis();
        String sso = makeSecureSSOToken("flow2-user");
