...
public class FastCommentsTheme {
    ...
    @Nullable
    private Integer replyButtonColor;

    @Nullable
    private Integer toggleRepliesButtonColor;

    @Nullable
    private Integer loadMoreButtonTextColor;
    ...
    @Nullable
    private Integer linkColorPressed;

    // Vote colors
    @Nullable
    private Integer voteCountColor;

    @Nullable
    private Integer voteCountZeroColor;

    @Nullable
    private Integer voteDividerColor;

    // Dialog colors
    @Nullable
    private Integer dialogHeaderBackgroundColor;

    @Nullable
    private Integer dialogHeaderTextColor;

    // Other UI colors
    @Nullable
    private Integer onlineIndicatorColor;

    // Live chat header colors
    @Nullable
    private Integer liveChatHeaderBackgroundColor;

    @Nullable
    private Integer liveChatHeaderTextColor;

    @Nullable
    private Integer liveChatConnectedDotColor;

    @Nullable
    private Integer liveChatDisconnectedDotColor;

    @Nullable
    private Integer liveChatUserCountTextColor;
    ...
    @Nullable
    public Integer getActionButtonColor() {
        return actionButtonColor;
    }

    @Nullable
    public Integer getReplyButtonColor() {
        return replyButtonColor;
    }

    @Nullable
    public Integer getToggleRepliesButtonColor() {
        return toggleRepliesButtonColor;
    }

    @Nullable
    public Integer getLoadMoreButtonTextColor() {
        return loadMoreButtonTextColor;
    }
    ...
    @Nullable
    public Integer getLinkColorPressed() {
        return linkColorPressed;
    }

    @Nullable
    public Integer getVoteCountColor() {
        return voteCountColor;
    }

    @Nullable
    public Integer getVoteCountZeroColor() {
        return voteCountZeroColor;
    }

    @Nullable
    public Integer getVoteDividerColor() {
        return voteDividerColor;
    }

    @Nullable
    public Integer getDialogHeaderBackgroundColor() {
        return dialogHeaderBackgroundColor;
    }

    @Nullable
    public Integer getDialogHeaderTextColor() {
        return dialogHeaderTextColor;
    }

    @Nullable
    public Integer getOnlineIndicatorColor() {
        return onlineIndicatorColor;
    }

    @Nullable
    public Integer getLiveChatHeaderBackgroundColor() {
        return liveChatHeaderBackgroundColor;
    }

    @Nullable
    public Integer getLiveChatHeaderTextColor() {
        return liveChatHeaderTextColor;
    }

    @Nullable
    public Integer getLiveChatConnectedDotColor() {
        return liveChatConnectedDotColor;
    }

    @Nullable
    public Integer getLiveChatDisconnectedDotColor() {
        return liveChatDisconnectedDotColor;
    }

    @Nullable
    public Integer getLiveChatUserCountTextColor() {
        return liveChatUserCountTextColor;
    }
}
